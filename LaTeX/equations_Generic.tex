...
\endlastfoot
    ...
    \begin{lay}control\end{lay} \\
        \hyperlink{"v:228"}{ 127 }\hypertarget{"e:127"}{  } &
    \begin{eq}{p}{_{}} := \textbf{Instantiate}({{\#}}{_{}}, {{\#}}{_{}})\end{eq} &
    \begin{lay}proportional gain\end{lay} &
    \begin{lay}control\end{lay} \\
        \hyperlink{"v:229"}{ 128 }\hypertarget{"e:128"}{  } &
    \begin{eq}{u}{_{N, p}} := \left( -{p}{_{}} \right) \, . \, {e}{_{N, p}}\end{eq} &
    \begin{lay}output of straight proportional temperature controller\end{lay} &
    \begin{lay}control\end{lay} \\
        \hyperlink{"v:230"}{ 129 }\hypertarget{"e:129"}{  } &
    \begin{eq}{{d^{heating}}}{_{N, p}} := \textbf{sign} \left( {u}{_{N, p}} \right)\end{eq} &
    \begin{lay}direction of heating\end{lay} &
    \begin{lay}control\end{lay} \\
    ...
    \begin{lay}control\end{lay} \\
        \hyperlink{"v:233"}{ 132 }\hypertarget{"e:132"}{  } &
    \begin{eq}{l}{_{N, p}} := \textbf{Instantiate}({u}{_{N, p}}, {{\#}}{_{}})\end{eq} &
    \begin{lay}maximum limit\end{lay} &
    \begin{lay}control\end{lay} \\
\hline
\end{longtable}